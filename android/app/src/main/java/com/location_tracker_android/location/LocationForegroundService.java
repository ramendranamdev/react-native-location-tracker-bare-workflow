...
import com.location_tracker_android.MainActivity;

public class LocationForegroundService extends Service implements LocationEventReceiver {
    public static final String CHANNEL_ID = "ForegroundServiceChannel";
    public static final int NOTIFICATION_ID = 1;
    public static final String LOCATION_EVENT_NAME = "com.location_tracker_android.LOCATION_INFO";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        mAlarmManager.setRepeating(AlarmManager.RTC, System.currentTimeMillis(), LOCATION_UPDATE_INTERVAL,
    ...
    public void createEventReceiver() {
        mEventReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                /*
                 * TODO: do any kind of logic in here with the LocationCoordinates class e.g.
                 * like a request to an API, etc --> all on the native side
                 */
            }
        };
    }
    ...
    private Notification createNotification() {
        ...
        return new NotificationCompat.Builder(this, CHANNEL_ID).setContentIntent(pendingIntent).build();
    }

    private void createLocationPendingIntent() {
        Intent i = new Intent(getApplicationContext(), LocationBackgroundService.class);
        mLocationBackgroundServicePendingIntent = PendingIntent.getService(getApplicationContext(), 1, i,
